...
<html lang="en">
    ...
    <head>
        ...
        <title>Moderator Section - Manage Players</title>
                            ...
                            <?php foreach ($admin_users as $key => $user): ?>
                                <tr>
                                    ...
                                    <?php if ($user['blocked'] == 1): ?>
                                        <td><a href="details.php?blocked=0&p_id=<?php echo $user['id'] ?>" class="unblock">unblock</a></td>
                                    <?php else: ?>
                                        <td><a href="details.php?blocked=1&p_id=<?php echo $user['id'] ?>" class="block">block</a></td>
                                    <?php endif; ?>
                                    <!--New Add Bloked area --> 
